import{c as M,u as A,d as x,r as G,e as K,i as B,f as Q,h as V,j as b,k as h,l as W,b as X}from"./assets/subscribeEmail-338e6ace.js";import"./assets/vendor-466561f8.js";const Z=document.querySelector(".product-list");async function _(){try{Z.addEventListener("click",e=>{const n=e.target.closest(".js-card"),i=e.target.closest(".js-btn");if(n){const a=n.getAttribute("data-id");i?(N(a),M(a),A(),f()):x(a)}})}catch(e){console.error(e)}}function N(e){const n=JSON.parse(localStorage.getItem("cartData"));Array.from(n).includes(e)?G(e):K(e)}async function f(){const e=JSON.parse(localStorage.getItem("cartData")),n=document.querySelectorAll(".js-card");Array.from(n).forEach(a=>{const s=a.dataset.id;e.forEach(r=>{s===r&&document.querySelector(`.js-btn[data-id='${r}']`).classList.add("added")})})}function m(e){return e.map(({img:n,_id:i,name:a,price:s,size:r,category:l,popularity:g})=>`
